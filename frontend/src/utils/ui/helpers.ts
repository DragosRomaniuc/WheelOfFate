...
export const spacing = (type: any, value: any, defaultValue = 1) => {
    ...
    if (typeof value === "string") {
      ...
      const spacingValue: any = value.match(/((?=.*[1-9])\d*(?:\.\d{1,2})|(\d*))x/);
  ...
  export const parseSpacing = (type: any, value: any, defaultValue = 1) => {
    const accepted = [
      "marginHorizontal",
      "marginVertical",
      "marginTop",
  ...
  export const getMargins = (value: any, defaultValue = 1) => {
    if (typeof value === "number") {
      return {
        marginTop: value,
        marginRight: value,
    ...
    if (typeof value === "string") {
      const marginValue: any = value.match(/((?=.*[1-9])\d*(?:\.\d{1,2})|(\d*))x/);
      return (
        marginValue && {
  ...
  export const getPaddings = (value: any, defaultValue = 1) => {
    if (typeof value === "number") {
      return {
        paddingTop: value,
        paddingRight: value,
    ...
    if (typeof value === "string") {
      const paddingValue: any = value.match(/((?=.*[1-9])\d*(?:\.\d{1,2})|(\d*))x/);
      return (
        paddingValue && {
